...
class DocumentUpdate(BaseModel):
    ...
    template_file_path: Optional[str] = Field(None, alias="templateFilePath")
    ...
    placeholders_json: Optional[str] = Field(None, alias="placeholdersJson")
    generation_prompt: Optional[str] = Field(None, alias="generationPrompt")
    generation_sources_json: Optional[str] = Field(None, alias="generationSourcesJson")
